...
export default function ButtonNavMenu({ state, setState }: ButtonNavMenuProps) {
    ...
    const btnPainel = "art:bg:white-01 art:hover:bg:black-01 art:font:black-01 art:hover:font:white-01 art:cursor:pointer art:p:sm art:border-rd:base art:bg:none art:flex"
